    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(0, 'Kutilmoqda'), (1, 'Qabul qilindi'), (2, 'Rad etildi'), (3, 'Tasdiqlandi'), (4, 'Tasdiqlanmadi'), (5, 'Arxiv')])),
            ],
        ),
        migrations.CreateModel(
            name='Category',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pers', multiselectfield.db.fields.MultiSelectField(choices=[('main', 'Asosiy'), ('order', 'Buyurtmalar'), ('statistic', 'Statistika'), ('operators', 'Operatorlar'), ('category', 'Kategoriya'), ('ads', 'Reklama'), ('fillial', 'Filliallar'), ('settings', 'Bot Sozlamalari'), ('followers', 'Foydalanuvchilar')], max_length=70)),
